<template>
  <div class="articlecps style_select">
    <div class="stylename">新闻列表组件</div>
    ...
    <div v-show="cptpage == 0">
      ...
      <ul class="seltypecon">
        ...
        <li v-if="seltype == '1'"><a>文章数量:</a><el-input class="input1" style="width:50px;" type="number" v-model="ArticleStyle.limitNum" placeholder="输入" min="0" minlength="1" maxlength="3" max="300"></el-input> 个</li>
      </ul>
    ...
    <div v-show="cptpage == 1">
      <ul class="btnchangestyle">
        ...
        <li><a>内边距:</a><el-input class="input1" style="width:60px;" type="number" v-model="ArticleStyle.pd" min="0" minlength="1" maxlength="3" max="300" placeholder="请输入"></el-input></li>
      </ul>
    </div>
  </div>
</template>
...
<style lang="less">
  ...
  .showArticlestyle .articlecps.style_select{transform:translateX(0);}
  .hidecps .showArticlestyle.articlecps{transform:translateX(100%);}
  .el-radio + .el-radio {
    margin-left: 10px;
  }
